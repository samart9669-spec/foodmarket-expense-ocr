...
const navItems = [
  ...
  {
    href: '/attendance/daily-approval',
    label: 'อนุมัติเวลางานรายวัน',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    href: '/reports/attendance/detail',
    label: 'ตรวจสอบรายบุคคล',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const adminItems = [
  ...
  {
    href: '/admin/recalc-status',
    label: 'ล้างสถานะย้อนหลัง',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
      </svg>
    ...
    <aside className="fixed left-0 top-0 h-full w-64 bg-gray-900 text-white flex flex-col z-50">
      <div className="p-6 border-b border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-semibold text-sm text-white">Powerone Networking</p>
            <p className="text-xs text-gray-400">ระบบจัดการเงินเดือน</p>
          </div>
        </div>
      </div>
