...
interface Employee {
  id: string; name: string; employee_type: string; daily_rate: number
...
export default function EmployeesPage() {
  ...
  const handleDelete = async (id: string, name: string) => {
    ...
    } catch (e) { console.error(e); alert('เกิดข้อผิดพลาด') } finally { setDeleting(null) }
  }
    ...
    <div className="space-y-6">
      ...
      <div className="card">
        <div className="flex flex-col sm:flex-row gap-3">
          <div className="flex-1"><input type="text" placeholder="ค้นหาชื่อพนักงาน..." value={search} onChange={(e) => setSearch(e.target.value)} className="input-field" /></div>
      ...
      <div className="card p-0 overflow-hidden">
        {filtered.length === 0 ? (
          <div className="text-center py-12 text-gray-400">
            ...
            <p className="text-sm mt-1"><Link href="/employees/new" className="text-blue-600 hover:underline">เพิ่มพนักงานใหม่</Link></p>
          </div>
        ) : (
            ...
            <table className="w-full">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  ...
                  <th className="table-header">ใบหน้า</th><th className="table-header">QR Code</th><th className="table-header">จัดการ</th>
                </tr>
              </thead>
                  ...
                  <tr key={emp.id} className="hover:bg-gray-50">
                    ...
                    <td className="table-cell">
                      <div className="flex items-center gap-2">
                        ...
                        <button onClick={() => handleDelete(emp.id, emp.name)} disabled={deleting === emp.id} className="text-red-500 hover:text-red-700 text-sm font-medium disabled:opacity-50">
