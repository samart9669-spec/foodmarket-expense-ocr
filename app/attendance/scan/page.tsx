      ...
      {scanMode === 'checkin' && (
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">
            เลือกกะเฉพาะเมื่อเข้าทำกะที่ไม่ใช่กะหลักของสาขา
            <br />
            เช็คอินรอบที่ 2 ของวันได้หลังเช็คเอาต์รอบแรกแล้ว จะถือเป็น
            <strong> กะพิเศษ</strong> — ไม่ยึดกะ ไม่จ่ายค่าแรงรายวัน นับเป็น OT ทั้งหมด
            (ทีละ 30 นาที ไม่ถึง 30 นาที ไม่นับ)
          </p>
        </div>
      )}
